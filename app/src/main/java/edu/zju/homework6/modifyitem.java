            ...
            addBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (TextUtils.isEmpty(content)) {
                        Toast.makeText(modifyitem.this,
                    ...
                    boolean succeed = saveNote2Database(content.toString().trim(),
                            getSelectedPriority());
                    if (succeed) {
                        Toast.makeText(modifyitem.this,"Note modify", Toast.LENGTH_SHORT).show();
                        setResult(Activity.RESULT_OK);
                    } else {
                        Toast.makeText(modifyitem.this,"Error", Toast.LENGTH_SHORT).show();
                    }
                    finish();
                }
            });
